...
VALUES ('store_config', 'DECA Coop de Barranquitas', 'Tu cooperativa escolar de confianza', 2, '9:00 AM - 2:00 PM', '#1e40af', '#3b82f6', '#f59e0b', '#0f172a')
ON CONFLICT (id) DO NOTHING;

-- NOTE: Admin users should be created through Supabase Auth dashboard
-- The users table will be populated when users register or are created manually
